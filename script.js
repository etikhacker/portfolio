...
const translations = {
  az: {
    ...
    "footer.tagline.html": "<span class=\"amber\">Vibe coding</span> ilə sürətli iterasiya — AI alətləri ilə ideyadan production-a qədər real işlək sistemlər.",
    "footer.col.nav.aria": "Səhifə naviqasiyası",
    "footer.col.nav": "Səhifə",
    "footer.col.more.aria": "Digər keçidlər",
    "footer.col.more": "Digər",
    "footer.col.social": "Əlaqə",
  ...
  en: {
    ...
    "footer.tagline.html": "Fast iteration with <span class=\"amber\">vibe coding</span> — using AI tools to ship real, working systems from idea to production.",
    "footer.col.nav.aria": "Page navigation",
    "footer.col.nav": "Page",
    "footer.col.more.aria": "Other links",
    "footer.col.more": "Other",
    "footer.col.social": "Connect",
